...
use {
    crate::{
        error::GatewayWalletError, events::Paused, seeds::GATEWAY_WALLET_SEED, state::GatewayWallet,
    },
    anchor_lang::prelude::*,
};

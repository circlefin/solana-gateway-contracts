...
describe("GatewayMinter: transferOwnership", () => {
  let svm: LiteSVM;
  ...
  it("should set pending owner when owner calls transferOwnership", async () => {
    ...
    expect(gatewayMinterAccount.pendingOwner).to.deep.equal(newOwner.publicKey);
  ...
  it("should allow clearing pending owner by setting to null address", async () => {
    ...
    expect(gatewayMinterAccount.pendingOwner).to.deep.equal(PublicKey.default);
  ...
  it("should allow transferring ownership to the same owner", async () => {
    ...
    expect(gatewayMinterAccount.owner).to.deep.equal(client.owner.publicKey);
    expect(gatewayMinterAccount.pendingOwner).to.deep.equal(
